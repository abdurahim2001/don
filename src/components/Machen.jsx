                                ...
                                <Nav className="me-auto my-3 my-lg-5" style={{ maxHeight: '1000px' }} navbarScroll>
                                    ...
                                    <section className={a.menu_section}>
                                        ...
                                        <div className={a.menu_text}>
                                            ...
                                            <NavLink href="./Glavnay"><b className={a.b_menu}>Консультация</b> </NavLink>
                                            <NavLink href="/Comer"> <b className={a.b_menu}>Техника</b></NavLink>
                                            <NavLink href="/Semena"><b className={a.b_menu}>Семена</b></NavLink>
                                        </div>
